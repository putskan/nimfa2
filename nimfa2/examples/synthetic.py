...
"""
    ...
    In that case the defaults would be used. General model parameters are explained in :mod:`nimfa2.mf_run`,
    ...
    or call the module's function::
        ...
        import nimfa2.examples
        nimfa2.examples.synthetic.run()
"""
...
def print_info(fit, idx=None):
    ...
    :type fit: :class:`nimfa2.models.mf_fit.Mf_fit`
...
def run_snmnmf(V, V1):
    ...
    """
    rank = 10
    snmnmf = nimfa2.Snmnmf(V, V1, seed="random_c", rank=rank, max_iter=12,
...
def run_bd(V):
    ...
    """
    rank = 10
    bd = nimfa2.Bd(V, seed="random_c", rank=rank, max_iter=12, alpha=np.zeros((V.shape[0], rank)),
...
def run_bmf(V):
    ...
    """
    rank = 10
    bmf = nimfa2.Bmf(V, seed="random_vcol", rank=rank, max_iter=12, initialize_only=True,
...
def run_icm(V):
    ...
    icm = nimfa2.Icm(V, seed="nndsvd", rank=rank, max_iter=12, iiter=20,
...
def run_lfnmf(V):
    ...
    rank = 10
    pnrg = np.random.RandomState()
    lfnmf = nimfa2.Lfnmf(V, seed=None, W=pnrg.rand(V.shape[0], rank), H=pnrg.rand(rank, V.shape[1]),
...
def run_lsnmf(V):
    ...
    """
    rank = 10
    lsnmf = nimfa2.Lsnmf(V, seed="random_vcol", rank=rank, max_iter=12, sub_iter=10,
...
def run_nmf(V):
    ...
    # Euclidean
    rank = 10
    nmf = nimfa2.Nmf(V, seed="random_vcol", rank=rank, max_iter=12, update='euclidean',
                     objective='fro')
    fit = nmf()
    print_info(fit)
    # divergence
    nmf = nimfa2.Nmf(V, seed="random_vcol", rank=rank, max_iter=12, initialize_only=True,
...
def run_nsnmf(V):
    ...
    """
    rank = 10
    nsnmf = nimfa2.Nsnmf(V, seed="random", rank=rank, max_iter=12, theta=0.5)
    fit = nsnmf()
    print_info(fit)
...
def run_pmf(V):
    ...
    """
    rank = 10
    pmf = nimfa2.Pmf(V, seed="random_vcol", rank=rank, max_iter=12, rel_error=1e-5)
    fit = pmf()
    print_info(fit)
...
def run_psmf(V):
    ...
    psmf = nimfa2.Psmf(V, seed=None, rank=rank, max_iter=12, prior=prng.rand(10))
    fit = psmf()
    print_info(fit)
...
def run_snmf(V):
    ...
    # SNMF/R
    rank = 10
    snmf = nimfa2.Snmf(V, seed="random_c", rank=rank, max_iter=12, version='r', eta=1.,
                       beta=1e-4, i_conv=10, w_min_change=0)
    fit = snmf()
    print_info(fit)
    # SNMF/L
    snmf = nimfa2.Snmf(V, seed="random_vcol", rank=rank, max_iter=12, version='l', eta=1.,
                       beta=1e-4, i_conv=10, w_min_change=0)
    fit = snmf()
    print_info(fit)
...
def run_sepnmf(V):
    ...
    sepnmf = nimfa2.SepNmf(V, rank=rank, selection='spa')
    fit = sepnmf()
    print_info(fit)

    sepnmf = nimfa2.SepNmf(V, rank=rank, selection='xray')
    fit = sepnmf()
    print_info(fit)

    sepnmf = nimfa2.SepNmf(V, rank=rank, compression='qr', selection='xray')
    fit = sepnmf()
    print_info(fit)

    sepnmf = nimfa2.SepNmf(V, rank=rank, compression='qr', selection='spa')
    fit = sepnmf()
    print_info(fit)

    sepnmf = nimfa2.SepNmf(V, rank=rank, compression='structured',
                           selection='xray')
    fit = sepnmf()
    print_info(fit)
    ...
    sepnmf = nimfa2.SepNmf(V, rank=rank, compression='count_gauss',
                           selection='xray')
    fit = sepnmf()
    print_info(fit)
