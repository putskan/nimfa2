...
"""
    This package contains nimfa2 library examples of usage. It demonstrates the following:
    ...
    Example using synthetic data set is intended as demonstration of the nimfa2 library since all currently implemented
